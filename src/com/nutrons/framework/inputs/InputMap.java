...
class InputMap {
    ...
    static final int XBOX_LEFT_TRIGGER = 2;
    static final int XBOX_RIGHT_TRIGGER = 3;
    static final int XBOX_R3 = 10;
    static final int XBOX_L3 = 9;


    // LogitechF310 D-Mode Controller Map
    static final int LOGITECH_X_1 = 0;
    static final int LOGITECH_X_2 = 2;
    static final int LOGITECH_Y_1 = 1;
    static final int LOGITECH_Y_2 = 3;

    static final int LOGITECH_X = 1;
    static final int LOGITECH_B = 3;
    static final int LOGITECH_A = 2;
    ...
    static final int LOGITECH_LEFT_TRIGGER = 8;
    static final int LOGITECH_RIGHT_TRIGGER = 9;
    static final int LOGITECH_R3 = 13;
    static final int LOGITECH_L3 = 12;
}
